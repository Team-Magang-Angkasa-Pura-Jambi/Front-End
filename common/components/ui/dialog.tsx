  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        ...
        "bg-background/80 fixed inset-0 z-50 backdrop-blur-[2px]",
    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "border-border rounded-lg border shadow-2xl",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "border-border/50 mt-2 flex flex-col-reverse gap-2 border-t pt-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    />
...
function DialogTitle({
  ...
  return (
    <div className="mb-1 flex items-center justify-center gap-2 sm:justify-start">
      ...
      <SquareActivity className="text-primary hidden h-5 w-5 shrink-0 sm:block" />
