  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          // Base Panel Styling
          "border-border bg-popover text-popover-foreground relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border shadow-xl",

          // Industrial Theme Accents
          "border-t-primary shadow-primary/5 border-t-[3px]",
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("bg-border -mx-1 my-1 h-px opacity-50", className)}
      {...props}
    />
  );
}
